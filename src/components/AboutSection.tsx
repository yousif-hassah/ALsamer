...
const AboutSection = () => {
  ...
  return (
    ...
    >
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-[hsl(45,50%,15%)] via-background to-background opacity-50" />

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        <div
          className={`grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center ${isRTL ? "lg:grid-flow-col-dense" : ""}`}
        >
          {/* Left Content */}
          <motion.div
          ...
          >
            <div className="glass-card-warm p-4 sm:p-6 lg:p-8">
              <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-xl sm:rounded-2xl bg-gradient-to-br from-primary/20 to-soft-yellow/20 flex items-center justify-center flex-shrink-0">
              ...
              <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-white/10">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="w-8 sm:w-12 h-1 bg-gradient-to-r from-primary to-soft-yellow rounded-full" />
