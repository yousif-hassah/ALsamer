...
import { Truck, Ship, Plane, FileCheck, Warehouse, HeadphonesIcon } from "lucide-react";
...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="relative py-16 sm:py-20 lg:py-24 bg-background overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-background via-[hsl(0,30%,6%)] to-background opacity-50" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <span className="tag-warm mb-3 sm:mb-4 inline-block text-[10px] sm:text-xs">{t("services.tag")}</span>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="glass-card p-4 sm:p-6 lg:p-8 h-full hover:shadow-card-hover transition-all duration-500">
                <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-primary/20 to-warm-orange/10 flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
