      ...
      <div className="relative h-48 sm:h-64 lg:h-80 mb-12 sm:mb-16 lg:mb-20">
          ...
          >
            <div className="glass-card p-3 sm:p-4 lg:p-5 transform -rotate-6 hover:rotate-0 transition-transform duration-500">
              ...
              <p className="text-xs sm:text-sm lg:text-base text-white/60 mt-2 sm:mt-3 text-center font-medium">{t("trust.shipments")}</p>
            </div>
          </motion.div>
          ...
          >
            <div className="glass-card p-3 sm:p-4 lg:p-5 transform rotate-6 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="flex items-center justify-between gap-2 sm:gap-3 mt-2 sm:mt-3 px-1">
                <span className="text-xs sm:text-sm lg:text-base text-white/60 font-medium">{t("trust.fleet")}</span>
                <div className="w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-br from-primary/30 to-primary/10 flex items-center justify-center">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-primary" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="glass-card p-4 sm:p-5 lg:p-6 rounded-2xl sm:rounded-3xl">
              <div className="w-14 h-14 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-xl sm:rounded-2xl bg-gradient-to-br from-primary via-[hsl(15,80%,45%)] to-warm-orange flex items-center justify-center shadow-xl shadow-primary/40">
              ...
              <p className="text-xs sm:text-sm lg:text-base text-white/60 mt-2 sm:mt-3 text-center whitespace-nowrap font-medium">{t("trust.global")}</p>
            </div>
          </motion.div>
        </div>
